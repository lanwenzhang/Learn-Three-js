...
import { color, metalness, roughness, SceneNode } from 'three/examples/jsm/nodes/Nodes.js'
...
gui.add(floor.material, 'displacementBias').min(-1).max(1).step(0.001).name('floorDisplacmentBias')
